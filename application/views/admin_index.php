    	...
    	<section class="content">
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3 id="todays_patient"> </h3> <sup style="font-size: 20px"></sup>
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3 id="todays_fees"><sup style="font-size: 20px"></sup></h3>
...
function getDatabaseBackup()
{
   ...
   $.ajax({
        type:"POST",
        url:"<?php echo base_url();?>index.php/Welcome/getBackup",
         data:{
            ...
            if(message!="")
            {
                alert('Back Up Successfully Done.');
            }
